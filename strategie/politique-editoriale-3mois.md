...
7. CTA — "Commente [MOT] pour recevoir [rapport]"
...
**La seule métrique qui compte : abonnés newsletter Beehiiv**

Métriques secondaires (pour ajuster le contenu) :
- Taux de commentaires CTA (GUIDE, SIGNAL, etc.)
- Portée des reels vs carrousels
- Sujets qui génèrent le plus de DM organiques

**Reporting mensuel (30 min, 1er lundi du mois) :**
- Abonnés newsletter : objectif atteint ?
- Post le plus performant : quel sujet, quel format ?
- Post le moins performant : à éviter ?
- Outil à tester le mois suivant : sondage stories ou décision personnelle ?
...
| Fichier | Contenu |
|---------|---------|
| `strategie/formats-contenu.md` | Specs techniques détaillées de chaque format |
| `strategie/strategie-2026.md` | Vision 24 mois, funnel complet, monétisation |
| `STRATEGIE.md` | Analyse concurrents, positionnement, piliers |
| `contenu/planning-publications.md` | Posts déjà créés, pipeline |
| `newsletter-posts/` | Archives des posts générés depuis newsletters |
| `.claude/skills/newsletter-to-instagram/SKILL.md` | Workflow skill newsletter → Instagram |
